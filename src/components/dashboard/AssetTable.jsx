      ...
      <div className="control-bar">
        <div className="section-title" style={{ flexWrap: "wrap", gap: 10 }}>
          ...
          <div
            ...
            style={{ fontSize: 12, height: "fit-content", padding: "4px 10px", margin: 0 }}
          >
        ...
        <div className="action-buttons">
          ...
          <button
            className="btn-action ripple-btn"
            onClick={() => {
      ...
      {sortedAssets.length === 0 ? (
        <div className="empty-state">
          ...
          <button
            ...
            style={{ width: "auto", marginTop: 8, paddingInline: 28, height: 48 }}
            onClick={() => {
              setEditingAsset(null);
              setModalOpen(true);
            }}
            ...
            <table className="asset-table">
              <thead>
                <tr>
                  ...
                  <SortTh sortKey="value" align="right">
                    มูลค่า
                  </SortTh>
                  <SortTh sortKey="gain" align="right">
                    กำไร/ขาดทุน
                  </SortTh>
                  <SortTh sortKey="today" align="right">
                    วันนี้
                  </SortTh>
                  <th />
                </tr>
                    ...
                    >
                        ...
                        <div className="asset-name-col">
                          ...
                          <div>
                            <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap", gap: 4 }}>
                              ...
                              <span className={`badge-type ${asset.category || "stock"}`}>
                                {asset.category === "gold"
                                  ? asset.symbol === "CL=F"
                                    ? "น้ำมัน"
                                    : "ทองคำ"
                                  : CATEGORY_LABELS[asset.category] || asset.category || "stock"}
                              </span>
                              {asset.broker && (
                                <span
                                  style={{
                              ...
                              {!isCashAsset && isBest && <span className="best-badge">🏆 Best</span>}
                            </div>
                              ...
                              {asset.extPrice != null && (
                                <div
                                  style={{
                                    fontSize: 10,
                                    fontWeight: 700,
                                    color: asset.extChangePct >= 0 ? "var(--gain)" : "var(--loss)",
                                    marginTop: 2
                                  }}
                                >
                      ...
                      <td style={{ textAlign: "right" }}>
                        {!hasPrices ? (
                          <div
                            className="skeleton skeleton-text"
                            style={{ width: 80, height: 16, marginLeft: "auto" }}
                          />
                        ) : (
                          <div>
                            ...
                            <div className="price-thb">
                              {isCashAsset ? `${fmt.qty(asset.qty)} ${asset.symbol}` : fmt.thb(asset.regValueTHB)}
                            </div>
                        ...
                        {!hasPrices || asset.costUSD === 0 || isCashAsset ? (
                          ...
                          <div>
                            <div className={`pnl-cell ${asset.regGainUSD >= 0 ? "positive" : "negative"}`}>
                              <div>
                                {asset.regGainUSD >= 0 ? "+" : ""}
                                {fmt.usd(asset.regGainUSD)}
                              </div>
                              <div style={{ fontSize: 12 }}>{fmt.pct(asset.regGainPct)}</div>
                            </div>
                            {asset.extPrice != null && (
                              <div
                                className={`pnl-cell ${asset.extGainUSD >= 0 ? "positive" : "negative"}`}
                                style={{ fontSize: 10, marginTop: 2 }}
                              >
                                <div>
                                  {asset.extType}: {asset.extGainUSD >= 0 ? "+" : ""}
                                  {fmt.usd(asset.extGainUSD)} ({fmt.pct(asset.extGainPct)})
                                </div>
                              </div>
                            )}
                          </div>
                      ...
                      <td style={{ textAlign: "right" }}>
                        {!hasPrices || isCashAsset ? (
                          ...
                          <div>
                            ...
                            {asset.extPrice != null && (
                              <div
                                className={`pnl-cell ${asset.extChangePct >= 0 ? "positive" : "negative"}`}
                                style={{ fontSize: 10, marginTop: 2 }}
                              >
                                <div>
                      ...
                      <td>
                        <div style={{ display: "flex", gap: 4 }}>
                          <button
                            ...
                            title={
                              asset.category === "fiat" || asset.type === "fiat"
                                ? "ฝากเงินสด / ถอนเงินสด"
                                : "ซื้อ / ขายสินทรัพย์"
                            }
                    ...
                    <div className="mobile-card-left">
                      ...
                      <div>
                        <div style={{ display: "flex", alignItems: "center", gap: 4, flexWrap: "wrap" }}>
                          ...
                          {!isCashAsset && isBest && (
                            <span className="best-badge" style={{ padding: "1px 6px", borderRadius: 4 }}>
                              🏆 Best
                            </span>
                          )}
                        </div>
                  ...
                  <div className="mobile-card-stats">
                    ...
                    <div className="mobile-stat">
                      ...
                      <span
                        ...
                        style={{
                          color: isCashAsset ? "var(--text-faint)" : asset.gainUSD >= 0 ? "var(--gain)" : "var(--loss)"
                        }}
                      >
                    ...
                    <div className="mobile-stat">
                      ...
                      <span
                        className="mobile-stat-value"
                        style={{
                          color: isCashAsset ? "var(--text-faint)" : asset.todayPct >= 0 ? "var(--gain)" : "var(--loss)"
                        }}
                      >
