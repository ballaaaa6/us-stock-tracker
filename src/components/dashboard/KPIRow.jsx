    ...
    <div className="kpi-row stagger-1">
      ...
      <div className={`kpi-card ${todayUp ? "gain-card" : "loss-card"}`}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 4 }}>
          <div
            className="kpi-value"
            style={{ color: todayUp ? "var(--gain)" : "var(--loss)", margin: 0, whiteSpace: "nowrap" }}
          >
        ...
        {todayChange !== 0 && (
          <div className="kpi-sub" style={{ marginTop: 2 }}>
            {todayUp ? "+" : "-"}
            {fmt.thb(Math.abs(todayChangeTHB))}
          </div>
        )}
      </div>
      ...
      <div className={`kpi-card ${totalUp ? "gain-card" : "loss-card"}`}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 4 }}>
          <div
            className="kpi-value"
            style={{ color: totalUp ? "var(--gain)" : "var(--loss)", margin: 0, whiteSpace: "nowrap" }}
          >
      ...
      <div className="kpi-card gold-card">
        ...
        {bestAsset ? (
          ...
          <div className="kpi-value small" style={{ color: "var(--text-muted)" }}>
            —
          </div>
        )}
      </div>
